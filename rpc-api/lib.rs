...
pub mod node {
    ...
    use plain_bitnames_types::{
        ...
        BlockIndexTx, Body, BroadcastResult, Coinbase, CoinbaseTxid,
...
pub mod wallet {
    ...
    use plain_bitnames_types::{
        ...
        Coinbase, CoinbaseTxid, EncryptionPubKey, FilledOutput,
    ...
    #[open_api(ref_schemas[
        ...
        Body, Coinbase, CoinbaseTxid, EncryptionPubKey, FilledOutput,
        FilledOutputContent, Header,
