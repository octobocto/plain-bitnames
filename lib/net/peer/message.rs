...
pub const fn magic_bytes(network: Network) -> MagicBytes {
    const PREFIX: [u8; 4] =
        [0b1100_1100, 0b0001_1001, 0b1100_0010, 0b1000_0000];
...
mod network_tests {
    ...
    const EXPECTED: [(Network, MagicBytes); 4] = [
        (Network::Regtest, [0xcc, 0x19, 0xc2, 0x80]),
        (Network::Signet, [0xcc, 0x19, 0xc2, 0x81]),
        (Network::Forknet, [0xcc, 0x19, 0xc2, 0x82]),
        (Network::Betanet, [0xcc, 0x19, 0xc2, 0x84]),
    ];
